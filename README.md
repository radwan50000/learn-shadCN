...
const chartData = [
  { "day": "Monday", "temperature": 22, "humidity": 65 },
  { "day": "Tuesday", "temperature": 25, "humidity": 60 },
  { "day": "Wednesday", "temperature": 27, "humidity": 58 },
  { "day": "Thursday", "temperature": 23, "humidity": 70 },
  { "day": "Friday", "temperature": 26, "humidity": 63 },
  { "day": "Saturday", "temperature": 28, "humidity": 55 },
  { "day": "Sunday", "temperature": 24, "humidity": 67 }
];
const chartConfig = {
  desktop: {
    label: "temperature",
  ...
  return (
    <ChartContainer config={chartConfig} className="min-h-[200px] w-full">
      <BarChart accessibilityLayer data={chartData}>
        ...
        <Bar dataKey="temperature" fill="var(--color-desktop)" radius={4} />
        <Bar dataKey="humidity" fill="var(--color-mobile)" radius={4} />
      </BarChart>
    </ChartContainer>
  );
};
